...
class Crawler:
    ...
    async def _run_with_session(self, session: BrowserSession, urls: dict, title: str, isbn: str = None) -> dict:
    ...
    async def _validate_candidates(self, session: BrowserSession, scored: list, title: str, isbn: str = None, depth: int = 3) -> dict:
