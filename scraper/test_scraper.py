...
async def scrape_with_limit(semaphore, pair):
    ...
    async with semaphore:
        ...
        return await scraper.scrape(
            pair["url"], pair["selectors"], pair.get("wait_selectors")
        )
...
async def main():
    ...
    pairs = [
        {
            "url": "https://jeyabookcentre.com/item/75242-the-last-wish?srsltid=AfmBOoq0kjNyIWejlHCi2lFKboz48AyTO-7XHfzT01s_FneKvcGsQHz5",
            "selectors": {
                "title": {"selector": "h1.text-3xl.font-bold.text-gray-900.mb-2"},
                "price": {
                ...
                "isbn": {"find_by_text": ("dt", "ISBN"), "then_next": "dd"},
                "description": {
        ...
        {
            "url": "https://www.sarasavi.lk/product/the-witcher---the-last-wish-147323106x",
            "wait_selectors": [
                ".ProductInner_productbox_details_price_discount__WKWSB"
            ],
            "selectors": {
                "title": {"selector": "h1.section-heading"},
                "price": {
                ...
                "description": {"selector": ".para--black", "preserve_semantics": True},
            },
        },
        {
            "url": "https://jumpbooks.lk/product/the-last-wish-reissue-introducing-the-witcher-now-a-major-netflix-show/",
            "selectors": {
